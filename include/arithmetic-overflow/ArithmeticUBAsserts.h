...
#define ASSERT_BINOP_OVERFLOW(operation, lhs, rhs, type)                       \
  Assert##operation<type>((lhs), (rhs), #type, __FILE__, __LINE__)
#define ASSERT_UNOP_OVERFLOW(operation, expr, type)                            \
