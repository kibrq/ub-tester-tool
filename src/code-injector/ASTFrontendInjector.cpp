...
void ASTFrontendInjector::insertLineBefore(
    const ASTContext* Context, const SourceLocation& Loc,
...
void ASTFrontendInjector::substituteSubstring(
    const ASTContext* Context, const SourceLocation& Begin,
...
void ASTFrontendInjector::substituteSubstring(
    const ASTContext* Context, const SourceRange& Range,
...
void ASTFrontendInjector::substituteSubstring(
    const ASTContext* Context, const CharSourceRange& Range,
    const std::string& Substitution) {
